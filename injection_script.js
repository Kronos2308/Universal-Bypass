...
ensureDomLoaded(()=>{
	...
	domainBypass("favpng.com", ()=>ifElement("div#countdown", a => {
		if (window.location.href.substr(19,12) == "png_download") safelyNavigate("https://files.favpng.com/api_download.php?k="+window.location.href.substr(32));
	}))
	})//example https://favpng.com/png_download/p6SwTKtR
